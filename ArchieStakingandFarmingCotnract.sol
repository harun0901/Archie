...
contract ArchieIunStakingAndFarming is Ownable, ReentrancyGuard {
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;         // How many allocation points assigned to this pool. DogeDash to distribute per block.
        uint256 lastRewardBlock;    // Last block number that DogeDash distribution occurs.
        uint256 accTokenPerShare;   // Accumulated DogeDash per share, times 1e12. See below.
        uint16 depositFeeBP;
    ...
    // DogeDash tokens created per block.
    ...
    // The block number when DogeDash mining starts.
    ...
    // Update the given pool's DogeDash allocation point and deposit fee. Can only be called by the owner.
    ...
    // View function to see pending DogeDash on frontend.
    ...
    // Deposit LP tokens to MasterChef for DogeDash allocation.
    ...
    // Pay or lockup pending DogeDash.
